            ...
            <div class="newsletter-wrapper d-md-flex justify-content-between align-items-center">
                <div class="newsletter-title mb-3 mb-md-0 me-md-4">
                    <div class="section_heading">
                        ...
                        <p class="sub_title text-white text-sm">Subscribe us to get latest news of promotional trip</p>
                    </div>
                </div>
                        ...
                        <div class="footer_widget">
                            ...
                            <div class="mb-4">
                                <div class="site_info d-flex align-items-center mb-4">
                                    ...
                                    <div>
                                        <h5>For Support</h5>
                                        <h6><a href="tel:+8801234567895">+88 01234567895</a></h6>
                                    </div>
                                </div>
                                <div class="site_info d-flex align-items-center mb-4">
                                    <div class="me-2">
                                    ...
                                    <div>
                                        <h5>Send Us Email</h5>
                                        <h6><a href="mailto:info@blog.com">info@blog.com</a></h6>
                                    </div>
                                </div>
                            </div>
